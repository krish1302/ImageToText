...
def main(input_file):
    ...
    modelDetector = r"D:\Downloads\ImageToText\frozen_east_text_detection.pb"
    modelRecognition = r"D:\downloads\ImageToText\ImageToText\newone\crnn.onnx"
    ...
    cap = cv.VideoCapture(input_file if input_file else 0)
